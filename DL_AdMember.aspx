<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DL_AdMember.aspx.cs" Inherits="Admin_Manager_NIT.DL_AdMember" %>
        ...
        <div id="content">
            <fieldset id="AddMemberField">
                ...
                <div id="search_area">
                    ...
                    <div id="textSearch">
                        <asp:TextBox class="DL_Search" ID="DL_SearchMember" runat="server" OnTextChanged="SearchTextBox_TextChanged" Font-Size="Medium" />
                    </div>
                    <div id="buttonSearch">
                ...
                <div id="result_area">
                    ...
                    <div id="textResult">
                        <asp:DropDownList class="DL_Select" ID="DL_SelectMember" runat="server" Font-Size="Medium"></asp:DropDownList>
                    </div>
                </div>
